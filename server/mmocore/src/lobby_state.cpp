...
lobby_state::lobby_state(state_transitioner& transitioner, std::shared_ptr<net_session> my_session,
...
{
  logger_.log_diagnostic(__func__);
  //notice, that i am NOT calling do_recv here. First i am waitin for the database task to complete, and calling do_recv as it's over
