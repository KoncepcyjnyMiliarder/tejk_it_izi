...
void default_friend_backend::on_friend_online_while_you_login(const std::string& his_nick)
{
...
void default_friend_backend::on_friend_login(const std::string& his_nick)
{
  net_socket::buffer buffer;
...
void default_friend_backend::on_friend_leave(const std::string& his_nick)
{
  net_socket::buffer buffer;
...
void default_friend_backend::on_new_friendship(const std::string& his_nick)
{
  net_socket::buffer buffer;
...
void default_friend_backend::on_broken_friendship(const std::string& his_nick)
{
  net_socket::buffer buffer;
...
void default_friend_backend::on_friendship_request(const std::string& his_nick)
{
  net_socket::buffer buffer;
...
void default_friend_backend::on_my_request_sent(const std::string& his_nick, friend_add_request_result result)
{
  net_socket::buffer buffer;
...
void default_friend_backend::on_friend_add_fail(const std::string& his_nick, friend_add_fail_reason reason)
{
  net_socket::buffer buffer;
...
void default_friend_backend::on_friend_removal_fail(const std::string& his_nick)
{
  net_socket::buffer buffer;
