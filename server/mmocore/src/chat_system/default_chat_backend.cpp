...
void
default_chat_backend::on_chat_message(const std::string& channel_name,
...
void
default_chat_backend::on_user_left_chat(const std::string& channel_name, const std::string& who)
{
  net_socket::buffer buffer;
...
void
default_chat_backend::on_user_joined_chat(const std::string& channel_name, const std::string& who)
{
  net_socket::buffer buffer;
...
void
default_chat_backend::on_whisper(const std::string& who, const std::string& message)
{
  net_socket::buffer buffer;
