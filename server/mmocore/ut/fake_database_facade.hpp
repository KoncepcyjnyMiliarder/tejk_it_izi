...
class fake_database_facade : public database_facade
{
...
public:
  ...
  virtual unsigned char_name_to_uid(const std::string& nickname) override;
  virtual lobby_character create_character(const std::string& nickname,
                                           unsigned owner_acc_id) override;
