...
class ingame_state : public client_state
{
  // now this little class is interesting, a consequence of the client_state
  // design it's only purpose is to be destroyed last, and in turn send the final
  // log-off packet maybe move it to other place soon
  struct finalizer
  {
...
public:
  ingame_state(state_transitioner& transitioner,
