...
class default_friend_backend : public friend_backend
{
private:
...
public:
  ...
  virtual void on_my_request_sent(const std::string& his_nick,
                                  friend_add_request_result result) override;
  virtual void on_friend_add_fail(const std::string& his_nick,
                                  friend_add_fail_reason reason) override;
