...
class pending_friend_requests
{
  ...
  using request_hashmap = std::unordered_map<single_friend_request,
                                             std::chrono::system_clock::time_point,
                                             single_friend_request::hash,
                                             single_friend_request::equal>;
...
public:
  ...
  operation_result process_add_friend_request(unsigned sender,
                                              unsigned recipient,
