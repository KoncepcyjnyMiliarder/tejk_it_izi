...
public:
  ...
  friend_system(world_registrar& online_player_registry,
  ...
  void process_req_friend_add(tii_entity_representative::const_reference my_representative,
                              const std::string& name);
  void process_req_friend_remove(tii_entity_representative::const_reference my_representative,
                                 const std::string& name);
};
