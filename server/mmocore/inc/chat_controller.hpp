...
class chat_controller
{
    ...
    chat_system_base<chat_participant>& chat_sys_;
    chat_participant my_representative_;
    std::list<chat_system_base<chat_participant>::chatroom_ptr> chatrooms_im_in_;

  public:

    chat_controller(chat_system_base<chat_participant>& chat_sys, std::shared_ptr<net_session> my_session, const std::string& my_name);
    ~chat_controller();
