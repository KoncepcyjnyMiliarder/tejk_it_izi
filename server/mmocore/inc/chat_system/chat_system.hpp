...
class chat_system
{
  ...
  void unregister_from_chatroom(tii_entity_representative::const_pointer my_representative,
                                chatroom* room);
...
public:
  ...
  void register_me(tii_entity_representative::const_reference my_representative,
                   std::unique_ptr<chat_backend> my_backend);
  void unregister_me(tii_entity_representative::const_reference my_representative);
  void join_chatroom(tii_entity_representative::const_reference my_representative,
                     const std::string& room_name);
  void leave_chatroom(tii_entity_representative::const_reference my_representative,
                      const std::string& room_name);
  void broadcast_message(tii_entity_representative::const_reference my_representative,
                         const std::string& room_name,
                         const std::string& msg);
  void whisper(tii_entity_representative::const_reference my_representative,
